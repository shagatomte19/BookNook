...
import { BookOpen, Calendar, MapPin, PenTool, UserPlus, UserCheck, MessageCircle } from 'lucide-react';
              ...
              {!isMe && (
                <div className="flex items-center justify-center md:justify-start gap-3">
                  <button 
                    ...
                    className={`px-6 py-2 rounded-xl font-bold text-sm flex items-center transition-all ${
                      isFollowing 
